...
Para crear un objeto en R a diferencia de otros lenguajes de programación, no se utiliza (comúnmente) el operador de asignación **=**, si no que utilizamos la asignación de forma direccional, es decir, con los siguientes elementos:

-   `<-`
-   `->`

**¿Porqué si el operador `=` funciona para declarar variables coexiste con los operadores `<-->`?** En general, el operador `=` está designado para la declaración de argumentos en funciones y, el operador `<-` se emplea de forma más tradicional para declarar variables.
...
En algunas ocasiones, nos encontraremos con que hemos almacenado objetos demasiado grandes en memoria, que una vez realizada unan operación, deseamos elimnar, para ello, disponemos de la función **`rm`**, a la cuál, pasaremos como parámetro el nombre de la variable a eliminar.
...
Información sobre docstring en R: https://cran.r-project.org/web/packages/docstring/vignettes/docstring_intro.html
...
-   Sobre las líneas seleccionadas: CNTRL + SHIFT + C
